...
#copy by recursive_backtracker

def algorithm_prim(size):
    ...
    while pos_list!=[]:  #repetir fins que no quedi cap casellela sense visitar
        ...
        for dir in dirList:  #anar provant de la lista de driecció si son posibles les direccións
            ...
            pos_list.remove(pos) #s'eleminia la posició acutual de la lista
        if pos_list!=[]:
            pos=random.choice(pos_list) #s'agafa un pos a l'azar de la lista
